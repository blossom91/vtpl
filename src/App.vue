                        ...
                        <div class="section-bd">
                            ...
                            <div class="item">
                                ...
                                <div class="item-bd">
                                    <ul>
                                        <li>
                                            代表华夏幸福基业总部对各大区的采购项目进行招采检查，主要检查招标采购的合规性、合理性及管控体系的有效性。
                                        </li>
                                        <li>担任该项目检查人员，负责招标采购检查等。</li>
                                    </ul>
                                </div>
                            ...
                            <div class="item">
                                ...
                                <div class="item-bd">
                                    <ul>
                                        <li>
                                            对北京粮食集团各项目公司2016-2017年度发生的项目从内部决策、项目立项、勘察设计、招标采购、合同管理、施工管理、竣工验收、档案管理八个方面进行检查。
                                        </li>
                            ...
                            <div class="item">
                                ...
                                <div class="item-bd">
                                    <ul>
                                        <li>
                                            对中粮置业有限公司安定门部分项目进行招采检查，主要检查项目招标采购的合规性与合理性。
                                        </li>
                        ...
                        <div class="section-bd">
                            ...
                            <div class="item">
                                ...
                                <div class="item-bd">
                                    <ul>
                                        <li>
                                            对远洋供方库进行梳理与关联关系的检查，并对供应商类别进行重新定义与划分。
                                        </li>
                                        <li>担任该项目检查人员。</li>
                                    </ul>
                                </div>
